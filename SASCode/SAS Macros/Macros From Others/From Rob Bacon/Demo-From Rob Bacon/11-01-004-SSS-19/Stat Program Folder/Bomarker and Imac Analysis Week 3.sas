...
%LET Ddata		=C:\Documents and Settings\ti4224\My Documents\My Work\Crb\11-01-004-SSS-19\Stat Data Folder;

* Define the directory for the SAS codes;
%LET Dcodes		=C:\Documents and Settings\ti4224\My Documents\My Work\Crb\11-01-004-SSS-19\Stat Program Folder;

* Define the directory for output file;                    
%LET Foutput	=C:\Documents and Settings\ti4224\My Documents\My Work\Crb\11-01-004-SSS-19\Stat Results Folder;

libname in "&Ddata";

%LET Title		= CRB 11-01-004 SSS 19 Treatment Phase;		        * User Input5 : Define the title for the study;
...
%LET VarList	= LogMalassezia LogHistamineNrm LogIL1raIL1aRatio LogIL1raNrm LogIL1aNrm LogProteinHistamine LogProteinCytokine
                  LogHistamine LogIL1ra LogIL1a LogHsaNrm LogInvolucrinNrm LogKeratins11011Nrm LogProteinSkinMap LogHsa
                  LogInvolucrin LogKeratins11011; 

%Let ResultsFileName=CRB 11-01-004 SSS 19 Biomarker and Imac Results Week 3;           
