...
* Updates 27/12/2013(Yasser): set wilcoxon rank sum test pvalues to be . if random or repeated statements are specified;
...
%do k=1 %to &ncomps;
  ...
  if  %length(&optinal_random_Statement)>0 then Wilcox_&k=.;
