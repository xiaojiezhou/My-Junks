...
%LET Title		= Study CRB XXX;            	* Define the title for the study;
%LET Indata		= in.crb_2b; 	* Define the input data set;
...
%LET Test		= 0.XX;                 	* Define the two sided p-value for testing significance;
%LET VarList	= Var1 Var2 etc;               	* List all the dependent variable. In case of more than one variable, list them space separated;

%LET ResultsFileName=CRB XXX Results;

options nodate nonumber symbolgen mprint mlogic;
libname in "&Ddata";
				
%include "&Dcodes.XXX_FormatsV1.sas";   
...
ods graphics / reset noborder width=400px height=500px
