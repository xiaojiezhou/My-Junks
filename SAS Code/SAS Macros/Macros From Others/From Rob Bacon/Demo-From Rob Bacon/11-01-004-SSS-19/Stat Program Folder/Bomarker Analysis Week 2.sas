...
%Let ResultsFileName=CRB 11-01-004 SSS 19 Biomarker Results Week 2;           
...
proc mixed data=datause;* noitprint noclprint noinfo;		*Proc Mixed3;
  where &sortvar=14; *week3 difference;
  by &byvar;
  class RandNo trt side;
